...
# p= B*z + C
# z=0    p=pmax   -> C = pmax
# z=L    p=0        -> B L + C = 0 -> B = -C/L
# B = -pmax/L ; C = pmax
# B = -4.5536 ; C = 45.536

plot 45.536 - 4.5536*x                                               title "Analytical" with lines linetype 1 linewidth 2 linecolor rgbcolor "black", \
     "pressure_drop-openfoam_sampling-10x10.gplt"  using 1:2 every 2 title "Mesh10"     with points pointtype 7 pointsize 0.5 linecolor rgbcolor "black", \
     "pressure_drop-openfoam_sampling-20x20.gplt"  using 1:2 every 2 title "Mesh20"     with points pointtype 2 pointsize 0.5 linecolor rgbcolor "black", \
     "pressure_drop-openfoam_sampling-40x40.gplt"  using 1:2 every 2 title "Mesh40"     with points pointtype 6 pointsize 0.5 linecolor rgbcolor "black"
